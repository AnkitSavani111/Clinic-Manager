...
function DoctorRecordTable() {
    ...
    const tabs = [
        { name: '20/09/2023', to: '/', current: false },
        { name: '25/09/2023', to: '/', current: false },
        { name: '2/10/2023', to: '/', current: false },
        { name: '8/10/2023', to: '/', current: true },
    ]
                ...
                <>
                    ...
                    <Transition.Root show={openDetails} as={Fragment}>
                        ...
                        >
                            ...
                            <div auto className='fixed inset-0 z-10 overflow-y-auto'>
                                            ...
                                            >
                                                <div className='space-y-8 divide-y divide-gray-200 sm:space-y-5'  >
                                                    <div className='space-y-6 sm:space-y-5'>
                                                        <div>
                                                            <h3 autoFocus className='text-lg font-medium leading-6 text-gray-900'>
                                                                Patient Information
                                                                <Link to="/" className="h-0 w-0" autoFocus />  {/* for focus on top jugad */}
                                                            </h3>
                                                        </div>
                                                        <div className='space-y-6 sm:space-y-5 '>
                                                            <div className="relative">
                                                                ...
                                                                <div className="relative flex justify-center">
                                                                    <span className="bg-white px-3 text-lg font-medium text-gray-900">Appointments Date</span>
                                                                </div>
                                                            </div>

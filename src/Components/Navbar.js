                                        ...
                                        {links.map((link) => (
                                            <Link
                                                ...
                                                className={classNames(
                                                    currentPath === link.path ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-500 hover:text-gray-700', "inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium"
                                                )}
                                            >
                                                {link.name}
                                            </Link>

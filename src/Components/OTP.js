                ...
                <div className=' sm:mx-auto sm:w-full sm:max-w-md'>
                    ...
                    <div className='bg-transparent py-8 sm:rounded-lg sm:px-10'>
                        <form className='space-y-6' onSubmit={handleSubmition}>
                            ...
                            <div>
                                {!resend ? (
                                    <p className='sm:font-medium sm:cursor-pointer sm:relative sm:top-2 relative top-2 font-medium sm:text-[14px] text-indigo-900 sm:text-indigo-900 sm:hover:text-slate-950 sm:duration-100' onClick={handleResendOTP}>
                                        Resend OTP
                                    </p>
                                ) : null}
                            </div>

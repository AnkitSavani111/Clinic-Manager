...
import { BarsArrowUpIcon, UsersIcon, MagnifyingGlassIcon, IdentificationIcon } from '@heroicons/react/20/solid'
                                                    ...
                                                    >
                                                        ...
                                                        <td className='relative text-blue-500 whitespace-nowrap py-4 pl-3 pr-4 text-left text-sm font-medium sm:pr-6'>
                                                            <button
                                                                ...
                                                                onClick={(e) => {
                                                                    e.preventDefault();
                                                                    nav("/doctordashb/Treatment/" + `${person._id}`, { state: { person } });
                                                                }
                                                    ...
                                                    <div className='space-y-6 sm:space-y-5'>
                                                        ...
                                                        <div className='space-y-6 sm:space-y-5 '>
                                                            ...
                                                            <div className='sm:grid sm:grid-cols-5 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5'>
                                                                ...
                                                                <p className='text-sm text-gray-700 content-center sm:col-span-4'>
                                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat explicabo ab dolores porro necessitatibus illo! Reiciendis dicta perspiciatis, ducimus harum, ratione tenetur quas rem recusandae aperiam ullam voluptas debitis exercitationem erroxr voluptatem corporis eaque.
                                                                </p>
                                                            </div>
